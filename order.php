<?php
    ...
    if(isset($_GET['idBill'])){
        $idBill = $_GET['idBill'];
        $del_idBill = $sale->del_Bill($idBill, $id);
    }
?>
            ...
            <div class="col-xl-3 col-md-4">
                <div class="my-account-menu mt-30">
                    <ul class="nav account-menu-list flex-column">
                        ...
                        <li>
                            <a href="address.php"><i class="fa fa-map-marker"></i> Địa Chỉ</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-pane fade active show" id="pills-order">
                        <div class="my-account-order account-wrapper">
                            ...
                            <div class="row pt-30 pb-30"style="border-top: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; justify-content: space-evenly;">
                                <a href="order.php" class="col-xl-2 col-md-2 text-center view-hover text-primary">
                                ...
                                <a href="shipping-order.php" class="col-xl-2 col-md-2 text-center view-hover"> 
                            ...
                            <div class="account-table text-center mt-25 table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            $get_cart = $ct->get_cart_ordered($id);
                                            if($get_cart){
                                                $i = 0;
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                }else echo '<td>Trống</td>';
                                            ?>
                                            <td>
                                                <?php
                                                    if($result['Status'] == '0') echo 'Chờ xác nhận...';
                                                    else if($result['Status'] == '1') echo 'Đang giao hàng...';
                                                    else if($result['Status'] == '2') echo 'Đã giao hàng!';
                                                    else echo 'Đã hủy!';
                                                ?>
                                            </td>
                                            ...
                                            <td style="display:flex; text-align:left">
                                                ...
                                                <?php
                                                    if($result['Status'] == '0'){
                                                ?>
                                                    <a class="view-hover" style="width:50%;" href="?idBill=<?php echo $result['idBill']?>&idCustomer=<?php echo $id; ?>" onclick="return confirm('Bạn có muốn hủy đơn hàng này không?');">Hủy đơn</a>
                                                <?php
                                                    }else if($result['Status'] == '1'){
                                                        echo '<a class="view-hover text-primary" style="width:60%;" href="order.php?conf_receive_idBill=';
                                                        echo $result['idBill'];
                                                        echo '">Xác nhận đã nhận hàng</a> ';
                                                    }
                                                ?>
                                            </td>
                                        </tr>
