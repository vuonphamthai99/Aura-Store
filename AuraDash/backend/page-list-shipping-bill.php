<?php
    ...
    if(isset($_GET['conf_success_idBill'])){
        $idBill = $_GET['conf_success_idBill'];
		$conf = $sale->conf_success_Bill($idBill);
    }
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <?php
                        $get_total_bill = $sale->total_shipping_bill();
                        if($get_total_bill){
                            while($result_total_bill = $get_total_bill->fetch_assoc()){
                    ?>
                    <h4 class="mb-3">Đơn Đang Giao ( Tổng: <?php echo $result_total_bill['total_bill'] ?> đơn )</h4>
                    <?php
                            }
                        }
                    ?>
        ...
        <div class="col-lg-12">
            ...
            <table class="data-tables table mb-0 tbl-server-info">
                ...
                <tbody class="ligth-body">
                    <?php
                        $get_cart = $ct->get_cart_shipping_ordered_all();
                        if($get_cart){
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center list-action">
                                ...
                                <a class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Xác nhận hoàn thành"
                                href="?conf_success_idBill=<?php echo $result['idBill']?>"><i class="ri-thumb-up-line mr-0"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php
