    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <?php
                        $get_total_bill = $sale->total_cancelled_bill();
                        if($get_total_bill){
                            while($result_total_bill = $get_total_bill->fetch_assoc()){
                    ?>
                    <h4 class="mb-3">Đơn Đã Hủy ( Tổng: <?php echo $result_total_bill['total_bill'] ?> đơn )</h4>
                    <?php
                            }
                        }
                    ?>
        ...
        <div class="col-lg-12">
            ...
            <table class="data-tables table mb-0 tbl-server-info">
                ...
                <tbody class="ligth-body">
                    <?php
                        $get_cart = $ct->get_cart_cancelled_ordered_all();
                        if($get_cart){
